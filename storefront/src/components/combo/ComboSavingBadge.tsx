...
import { comboSavingPercent, formatPercent, type ComboPricing } from "@/lib/combos";
 ...
 *
 * RENDERS NOTHING when there is no saving to claim. A curator can pin a box at exactly
 * what its parts cost (the backend clamps a pinned amount to the component total), and
 * "Save ₦0 · 0% off" is a worse badge than no badge. */
